...
_MULTIBOXLOSSPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='pose_weight', full_name='caffe.MultiBoxLossParameter.pose_weight', index=24,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='pose_loss_type', full_name='caffe.MultiBoxLossParameter.pose_loss_type', index=25,
...
_MULTIBOXLOSSPARAMETER.fields_by_name['pose_loss_type'].enum_type = _MULTIBOXLOSSPARAMETER_CONFLOSSTYPE
